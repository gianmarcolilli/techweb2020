...
export class DummyApiService {
  ...
  deleteStory(id: number) {
    return this.http.delete('https://site181965.tw.cs.unibo.it/api/stories/' + id);
  }
  //per eliminare un attività verificando l'id
  deleteActivity(activityId: number) {
    return this.http.delete('https://site181965.tw.cs.unibo.it/api/stories/' + activityId);
  }
  ...
  getStories(): Observable<any> {
    return this.http.get('https://site181965.tw.cs.unibo.it/api/stories/');
  }

  // ci restituisce la singola storia,verificando l'id
  getStoria(id: number): Observable<any> {
    return this.http.get("https://site181965.tw.cs.unibo.it/api/stories/" + id)
  }

  getStep(idStoria: number) : Observable<any> {
    return this.http.get("https://site181965.tw.cs.unibo.it/api/stories/" + idStoria)
  }

  //ci restituisce tutte le partite
  getGames(): Observable<any> {
    return this.http.get('https://site181965.tw.cs.unibo.it/api/games/');
  }

  //ci restituisce la singola partita,verificando l'id
  getGame(id: number): Observable<any> {
    return this.http.get("https://site181965.tw.cs.unibo.it/api/games/" + id)
  }
  ...
  updateStoria(storia: Storia) {
    ...
    // console.log(options);
    return this.http.put("https://site181965.tw.cs.unibo.it/api/stories/" + storia.id, storia)
  }
 // per salvare le modifiche di una partita nel caso in cui la partita è di tipologia Gruppo o Classe
  updateGame(idPartita: number, prossimoId: number, punteggio: number) {
    ...
    return this.http
      .put("https://site181965.tw.cs.unibo.it/api/games/" + idPartita, {
  ...
  addNewStory(storyData) {
    return this.http.post<{ message: string, storia: Storia }>("https://site181965.tw.cs.unibo.it/api/stories/", storyData)
  }
  ...
  addNewGame(idSquadra: Number, idClasse: Number, idPartita: Number, numeroPlayer: Number) {
    ...
    return this.http.post<{ message: string, game: Game }>("https://site181965.tw.cs.unibo.it/api/games/", gameData)
  }
